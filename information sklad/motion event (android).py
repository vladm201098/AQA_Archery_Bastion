...
Здесь много крутых модулей с мув ивентами : 1.Мультитач \2.Swipe \3.Converter coordinates \4.Swipe two fingers
\5.Long press the app and drag it to the trash can to delete - Удерждание приложения и перенос в корзину
